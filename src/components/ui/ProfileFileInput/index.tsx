...
import styles from "./ProfileFileInput.module.css";

export interface ProfileFileInputProps {
  name: string;
  label: string;
  required?: boolean;
  helpText?: string;
...
export function ProfileFileInput({
  name,
  label,
  required = false,
  helpText,
  ...
  const defaultProfileImage = "/user.gif";
